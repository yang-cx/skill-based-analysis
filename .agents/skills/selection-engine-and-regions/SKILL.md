---
name: selection-engine-and-regions
description: "Repository-specific workflow and policy for Selection Engine and Regions. Use when Codex needs the required artifacts, validation checks, execution steps, or constraints for this analysis stage in the repo."
---
