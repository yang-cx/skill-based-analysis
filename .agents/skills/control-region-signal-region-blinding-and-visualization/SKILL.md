---
name: control-region-signal-region-blinding-and-visualization
description: "Repository-specific workflow and policy for Control/Signal Region Blinding and Visualization. Use when Codex needs the required artifacts, validation checks, execution steps, or constraints for this analysis stage in the repo."
---
