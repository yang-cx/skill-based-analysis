---
name: stattool-optional-pyhf-backend
description: "Repository-specific workflow and policy for StatTool Optional PyHF Backend. Use when Codex needs the required artifacts, validation checks, execution steps, or constraints for this analysis stage in the repo."
---
