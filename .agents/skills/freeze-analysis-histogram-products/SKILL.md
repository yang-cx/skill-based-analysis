---
name: freeze-analysis-histogram-products
description: "Repository-specific workflow and policy for Freeze Analysis Histogram Products. Use when Codex needs the required artifacts, validation checks, execution steps, or constraints for this analysis stage in the repo."
---
...
### When To Use
- Run immediately after `$histogramming-and-templates` is complete.
