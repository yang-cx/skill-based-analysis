---
name: event-io-and-columnar-model
description: "Repository-specific workflow and policy for Event IO and Columnar Model. Use when Codex needs the required artifacts, validation checks, execution steps, or constraints for this analysis stage in the repo."
---
