---
name: signal-background-strategy-and-cr-constraints
description: "Repository-specific workflow and policy for Signal/Background Strategy and CR Constraints. Use when Codex needs the required artifacts, validation checks, execution steps, or constraints for this analysis stage in the repo."
---
