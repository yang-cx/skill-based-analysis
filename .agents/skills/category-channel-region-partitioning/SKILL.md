---
name: category-channel-region-partitioning
description: "Repository-specific workflow and policy for Category/Channel x Region Partitioning (SR/CR/SB/VR) for LHC Analyses. Use when Codex needs the required artifacts, validation checks, execution steps, or constraints for this analysis stage in the repo."
---
