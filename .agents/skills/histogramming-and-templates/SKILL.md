---
name: histogramming-and-templates
description: "Repository-specific workflow and policy for Histogramming and Templates. Use when Codex needs the required artifacts, validation checks, execution steps, or constraints for this analysis stage in the repo."
---
