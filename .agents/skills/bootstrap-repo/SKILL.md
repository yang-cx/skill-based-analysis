---
name: bootstrap-repo
description: "Repository-specific workflow and policy for Bootstrap Repo. Use when Codex needs the required artifacts, validation checks, execution steps, or constraints for this analysis stage in the repo."
---
