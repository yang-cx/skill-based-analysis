---
name: read-summary-and-validate
description: "Repository-specific workflow and policy for Read Summary and Validate. Use when Codex needs the required artifacts, validation checks, execution steps, or constraints for this analysis stage in the repo."
---
...
- this validation skill is executed after `$agent-pre-flight-fact-check` has confirmed execution readiness
