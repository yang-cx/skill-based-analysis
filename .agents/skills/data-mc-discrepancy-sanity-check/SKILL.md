---
name: data-mc-discrepancy-sanity-check
description: "Repository-specific workflow and policy for Data-MC Discrepancy Sanity Check. Use when Codex needs the required artifacts, validation checks, execution steps, or constraints for this analysis stage in the repo."
---
