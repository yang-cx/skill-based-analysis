---
name: mc-normalization-metadata-stacking
description: "Repository-specific workflow and policy for MC Normalization from Open-Data Metadata for Multi-Component Stacks. Use when Codex needs the required artifacts, validation checks, execution steps, or constraints for this analysis stage in the repo."
---
