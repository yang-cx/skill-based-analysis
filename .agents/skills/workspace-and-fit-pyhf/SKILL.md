---
name: workspace-and-fit-pyhf
description: "Repository-specific workflow and policy for Workspace and Fit (RooFit-Primary for H to gammagamma). Use when Codex needs the required artifacts, validation checks, execution steps, or constraints for this analysis stage in the repo."
---
