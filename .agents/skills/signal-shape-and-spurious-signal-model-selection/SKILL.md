---
name: signal-shape-and-spurious-signal-model-selection
description: "Repository-specific workflow and policy for Signal Shape and Spurious-Signal Background Model Selection. Use when Codex needs the required artifacts, validation checks, execution steps, or constraints for this analysis stage in the repo."
---
