---
name: cut-flow-and-yields
description: "Repository-specific workflow and policy for Cut Flow and Yields. Use when Codex needs the required artifacts, validation checks, execution steps, or constraints for this analysis stage in the repo."
---
